...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/kristiyanP/SpeechMaster'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kristiyanP' => 'petkris_bg@hotmail.it' }
  s.source           = { :git => 'https://github.com/kristiyanP/SpeechMaster.git', :tag => s.version.to_s }
